...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Get User
     */
    async getUserUsersIdGetRaw(requestParameters: GetUserUsersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
     ...
     * Get User
     */
    async getUserUsersIdGet(requestParameters: GetUserUsersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
